...
var cargaInicial = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return workbook.xlsx.readFile("cargainicial.xlsx");
          case 4:
            worksheet = workbook.getWorksheet(1); // Iterar sobre cada fila del archivo Excel y llamar a signUpUser
            worksheet.eachRow({
              includeEmpty: false
            }, /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(row, rowNumber) {
                var _row$values, primero, opcion, nombre, apellido, usuario, email, opcionPerJur, existingUser;
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _row$values = _slicedToArray(row.values, 7), primero = _row$values[0], opcion = _row$values[1], nombre = _row$values[2], apellido = _row$values[3], usuario = _row$values[4], email = _row$values[5], opcionPerJur = _row$values[6];
                        _context.prev = 2;
                        _context.next = 5;
  ...
  return function cargaInicial(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.cargaInicial = cargaInicial;