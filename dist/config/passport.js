...
_passport["default"].use("login", new LocalStrategy({
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, usuario, password, done) {
    var user, match, codigoRepa, tempDir, maxTempDirLifetime;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          codigoRepa = user.codigoRepa;
          tempDir = _path["default"].join(__dirname, "..", "files", codigoRepa, "temp");
          ...
          maxTempDirLifetime = 3600; // Programar la tarea para eliminar el directorio temporal después del tiempo de vida máximo
          setTimeout(function () {
            _fs["default"].rm(tempDir, {
              recursive: true
            }, function (err) {
              if (err) {
