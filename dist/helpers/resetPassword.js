...
var generateResetPasswordToken = exports.generateResetPasswordToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email) {
    var TOKEN_EXPIRATION_TIME, user, payload, token, now, expirationTime;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          TOKEN_EXPIRATION_TIME = 60 * 60 * 1000; // 1 hora en milisegundos
          _context.next = 3;
        ...
        case 6:
          payload = {
            email: user.email
          }; // incluir el email del usuario en el payload
          token = _jsonwebtoken["default"].sign(payload, _config.JWT_SECRET, {
            expiresIn: TOKEN_EXPIRATION_TIME
          }); // generar un JWT con el payload y una clave secreta
          now = new Date();
          expirationTime = new Date(now.getTime() + TOKEN_EXPIRATION_TIME); // calcular la hora de expiración
  ...
  return function generateResetPasswordToken(_x) {
    return _ref.apply(this, arguments);
  };
}();
var verifyResetPasswordToken = exports.verifyResetPasswordToken = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(token) {
    var decodedToken, email, user, now;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          decodedToken = _jsonwebtoken["default"].verify(token, _config.JWT_SECRET); // verificar y decodificar el token
          email = decodedToken.email; // obtener el email del usuario desde el payload
          _context2.next = 5;
          return _Usuarios["default"].findOne({
            email: email
          });
