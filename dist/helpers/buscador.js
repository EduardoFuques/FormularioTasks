...
exports.getUsersWithForms = exports.getPJWithForms = exports.getEmpresasWithForms = void 0;
var _Usuarios = _interopRequireDefault(require("../models/Usuarios.js"));
...
var getUsersWithForms = exports.getUsersWithForms = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var rawUsersWithForms, usersWithForms;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _Usuarios["default"].aggregate([{
            $lookup: {
              from: "forms",
              localField: "usuario",
        ...
        case 3:
          rawUsersWithForms = _context.sent;
          // Convierte cada documento en un objeto plano de JavaScript utilizando la función JSON.parse(JSON.stringify())
          usersWithForms = rawUsersWithForms.map(function (doc) {
            var userWithForms = JSON.parse(JSON.stringify(doc));

            // Verifica si el usuario tiene un formulario
            if (userWithForms.form.length > 0) {
              var localidadIndex = userWithForms.form[0].domicilio[0].localidad;

              // Verifica si el índice de la localidad es un número
              if (!isNaN(localidadIndex)) {
                userWithForms.localidad = _arrays.domiciliosOpc[localidadIndex].localidad;
              }
            ...
            if (userWithForms.medios && userWithForms.medios.length > 0) {
              var mediosStrings = userWithForms.medios.map(function (indice) {
            ...
            if (userWithForms.areaDes && userWithForms.areaDes.length > 0) {
              var _mediosStrings = userWithForms.areaDes.map(function (indice) {
                return _arrays.areaDesOpc[indice].medio;
              });
              userWithForms.areaDes = _mediosStrings;
            }
            if (userWithForms.areaComp && userWithForms.areaComp.length > 0) {
              var _mediosStrings2 = userWithForms.areaComp.map(function (indice) {
                return _arrays.areasCompOpc[indice].medio;
              });
              userWithForms.areaComp = _mediosStrings2;
            }
            return userWithForms.form.length > 0 ? userWithForms : null;
          }).filter(Boolean);
          return _context.abrupt("return", usersWithForms);
        case 8:
          _context.prev = 8;
  ...
  return function getUsersWithForms() {
    return _ref.apply(this, arguments);
  };
}();
var getEmpresasWithForms = exports.getEmpresasWithForms = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          rawUsersWithForms = _context2.sent;
          // Convierte cada documento en un objeto plano de JavaScript utilizando la función JSON.parse(JSON.stringify())
          usersWithForms = rawUsersWithForms.map(function (doc) {
            var userWithForms = JSON.parse(JSON.stringify(doc));
          ...
          return _context2.abrupt("return", usersWithForms);
        case 8:
          _context2.prev = 8;
  ...
  return function getEmpresasWithForms() {
    return _ref2.apply(this, arguments);
  };
}();
var getPJWithForms = exports.getPJWithForms = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var rawPJWithForms, PJWithForms;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          rawPJWithForms = _context3.sent;
          // Convierte cada documento en un objeto plano de JavaScript utilizando la función JSON.parse(JSON.stringify())
          PJWithForms = rawPJWithForms.map(function (doc) {
            var PJWithForms = JSON.parse(JSON.stringify(doc));

            // Verifica si el usuario tiene un formulario
            if (PJWithForms.form.length > 0) {
              var localidadIndex = PJWithForms.form[0].domicilio[0].localidad;

              // Verifica si el índice de la localidad es un número
              if (!isNaN(localidadIndex)) {
                PJWithForms.localidad = _arrays.domiciliosOpc[localidadIndex].localidad;
              }
          ...
          return _context3.abrupt("return", PJWithForms);
        case 8:
          _context3.prev = 8;
  ...
  return function getPJWithForms() {
