...
var renderAdmin = exports.renderAdmin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var usersWithForms, PJWithForms, combinedData, admin;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 6;
          return (0, _buscador.getPJWithForms)();
        case 6:
          PJWithForms = _context.sent;
          // Añadir una propiedad 'tipoUsuario' para distinguir entre usuarios y personas jurídicas
          usersWithForms = usersWithForms.map(function (user) {
            return _objectSpread(_objectSpread({}, user), {}, {
              tipoUsuario: 'Usuario'
            });
          });
          PJWithForms = PJWithForms.map(function (pj) {
            return _objectSpread(_objectSpread({}, pj), {}, {
              tipoUsuario: 'Persona Jurídica'
            });
          });

          // Combinar ambos conjuntos de datos
          combinedData = [].concat(_toConsumableArray(usersWithForms), _toConsumableArray(PJWithForms)); // Calcular días desde la última actualización y resultadoUpdated para todos los elementos
          combinedData.forEach(function (datitos) {
...
var filtroBuscadorAdmin = exports.filtroBuscadorAdmin = /*#__PURE__*/function () {
...
var adminPJ = exports.adminPJ = /*#__PURE__*/function () {
...
var adminPF = exports.adminPF = /*#__PURE__*/function () {
...
var updateAdminiaavim = exports.updateAdminiaavim = /*#__PURE__*/function () {
...
var updateAdminEmail = exports.updateAdminEmail = /*#__PURE__*/function () {
