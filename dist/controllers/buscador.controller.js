...
exports.renderBuscadorPersonas = exports.renderBuscadorEmpresas = exports.filtroBuscadorPersonas = exports.filtroBuscadorEmpresas = void 0;
...
var filtroBuscadorPersonas = exports.filtroBuscadorPersonas = /*#__PURE__*/function () {
        ...
        case 5:
          ...
          filteredUsers = filteredUsersWithForms.filter(function (user) {
            return user.nombre.toLowerCase().includes(Vquery) || user.apellido.toLowerCase().includes(Vquery) || user.localidad.toLowerCase().includes(Vquery) || user.medios.some(function (medio) {
              ...
              return area.toLowerCase().includes(Vquery);
            }) || user.areaComp.some(function (area) {
              return area.toLowerCase().includes(Vquery);
            });
          });
...
var renderBuscadorPersonas = exports.renderBuscadorPersonas = /*#__PURE__*/function () {
...
var renderBuscadorEmpresas = exports.renderBuscadorEmpresas = /*#__PURE__*/function () {
...
var filtroBuscadorEmpresas = exports.filtroBuscadorEmpresas = /*#__PURE__*/function () {
