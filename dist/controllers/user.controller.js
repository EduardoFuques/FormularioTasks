...
exports.signUpUser = exports.signInUser = exports.renderSignUp = exports.renderSignIn = exports.logOut = exports.autenticacion = void 0;
var _Usuarios = _interopRequireWildcard(require("../models/Usuarios"));
...
var signUpUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var errors, _req$body, opcion, nombre, apellido, usuario, email, password, confirm_password, user, rol, emailUser, dniUser, tipoDoc, newUser;
...
var signInUser = function signInUser(req, res) {
  try {
    var _req$body2 = req.body,
      usuario = _req$body2.usuario,
      password = _req$body2.password;
    console.log(usuario);
    _Usuarios["default"].findOne({
      usuario: usuario
      ...
      if (err) {
        ...
        (0, _Usuarios.isCorrectPassword)(password, usuario, function (err, result) {
          if (err) {
